...
async function main() {
  ...
  const matchesData: [number, string, string, string, string, string][] = [
    ...
    [21, 'D', 'TUR', 'PAR', '2026-06-20', '00:00'],
    [22, 'D', 'USA', 'AUS', '2026-06-19', '15:00'],
    [23, 'D', 'PAR', 'AUS', '2026-06-25', '22:00'],
    [24, 'D', 'TUR', 'USA', '2026-06-25', '22:00'],
    // Group E
    ...
    // Group H
    [43, 'H', 'ESP', 'CPV', '2026-06-15', '12:00'],
    [44, 'H', 'KSA', 'URU', '2026-06-15', '18:00'],
    [45, 'H', 'ESP', 'KSA', '2026-06-21', '12:00'],
    [46, 'H', 'URU', 'CPV', '2026-06-21', '18:00'],
    ...
    [56, 'J', 'AUT', 'JOR', '2026-06-17', '00:00'],
    [57, 'J', 'ARG', 'AUT', '2026-06-22', '13:00'],
    [58, 'J', 'JOR', 'ALG', '2026-06-22', '23:00'],
